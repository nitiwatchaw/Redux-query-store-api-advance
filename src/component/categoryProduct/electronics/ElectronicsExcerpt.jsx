...
const ElectronicsExcerpt = ({ productId }) => {

    const { product, isLoading } = useGetElectronicsShopQuery('getElectronicsShop', {
    ...
    return (
        <>
            {isLoading ? (
                ...
                <div className="mt-3 flex items-center gap-4 bg-slate-50 p-2">
...
export default ElectronicsExcerpt